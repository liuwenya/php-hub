...
<a href="javascript:javascript:document.location ='./?up=<?php echo $u_action; ?>?page='+document.getElementById('page').value;" title=""><img src="./images/next.gif" alt="" /></a>
        <div class="clear"></div>
    </div>